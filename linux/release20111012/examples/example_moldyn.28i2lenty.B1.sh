...
outfile_traj="$moldyn_dir/laboro/new_LC/5CB/28i2lenty_work/28i2lenty B1.traj"

./example_moldyn -t 2 -T 295 -B 1 -N 2000000000 -f 5000 -v 17 "$infile_gpr" "$infile_box" "$outfile_traj" &
