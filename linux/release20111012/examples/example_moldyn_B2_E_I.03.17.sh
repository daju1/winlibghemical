...
outfile_traj="$moldyn_dir/conicnanotube.03/first_frame_B2_E_I.traj_v17"

make all
./example_moldyn -E -I -B 2 -N 2000000000 -f 1000 -v 17 "$infile_gpr" "$infile_box" "$outfile_traj" &
