...
outfile_traj="$moldyn_dir/conicnanotube.03/first_frame_B2_E_I_locked.traj_v17"

./example_moldyn -E -I -t 2 -B 2 -N 2000000000 -f 1000 -v 17 "$infile_gpr" "$infile_box" "$outfile_traj" &
