...
infile_gpr="$moldyn_dir/conicnanotube.05.x2/conicnanotube.membrana Ne 14 x2.gpr"
infile_box="$moldyn_dir/conicnanotube.05.x2/box"
outfile_traj="$moldyn_dir/conicnanotube.05.x2/test.traj_v19"
