...
outfile_traj="$moldyn_dir/conicnanotube.03/v19/first_frame_B2_E.traj_v19"

./example_moldyn -E -B 2 -N 2000000000 -f 1000 -v 19 "$infile_gpr" "$infile_box" "$outfile_traj" &
