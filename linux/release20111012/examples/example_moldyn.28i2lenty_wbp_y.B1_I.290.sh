...
outfile_traj="$moldyn_dir/laboro/new_LC/5CB/28i2lenty_wbp_y/28i2lenty_wbp_y_B1_I_290.traj"

./example_moldyn -t 2 -T 290 -I -B 1 -N 2000000000 -f 5000 -v 17 "$infile_gpr" "$infile_box" "$outfile_traj" &
