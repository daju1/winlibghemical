/* rsp.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int rsp_(a, n, matz, w, z__)
doublereal *a;
integer *n, *matz;
doublereal *w, *z__;
{
    ...
    /* Local variables */
    static integer ierr;
    extern /* Subroutine */ int tred3_();
    static integer i__, j;
    extern /* Subroutine */ int trbak3_();
    static integer nm, nv;
    extern /* Subroutine */ int epseta_(), tqlrat_();
    static doublereal fv1[420], fv2[420], eta, eps;
    extern /* Subroutine */ int tql2_();
...
/* Subroutine */ int epseta_(eps, eta)
doublereal *eps, *eta;
{
...
/* Subroutine */ int tql2_(nm, n, d__, e, z__, ierr, eps)
integer *nm, *n;
...
/* Subroutine */ int tqlrat_(n, d__, e2, ierr, eps)
integer *n;
doublereal *d__, *e2;
integer *ierr;
doublereal *eps;
...
/* Subroutine */ int trbak3_(nm, n, nv, a, m, z__)
integer *nm, *n, *nv;
doublereal *a;
integer *m;
doublereal *z__;
...
/* Subroutine */ int tred3_(n, nv, a, d__, e, e2, eps, eta)
integer *n, *nv;
doublereal *a, *d__, *e, *e2, *eps, *eta;
{
    /* System generated locals */
