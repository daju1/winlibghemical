/* dgetri.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int dgetri_(n, a, lda, ipiv, work, lwork, info)
integer *n;
doublereal *a;
integer *lda, *ipiv;
doublereal *work;
integer *lwork, *info;
{
    ...
    extern /* Subroutine */ int mMdswap_(), dtrsm_();
...
/*     APPLY COLUMN INTERCHANGES. */
	...
	jp = ipiv[j];
	if (jp != j) {
	    mMdswap_(n, &a[j * a_dim1 + 1], &c__1, &a[jp * a_dim1 + 1], &c__1);
	}
/* L60: */
    }
