/* readmo.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int readmo_()
{
    /* Initialized data */

    static char space[1+1] = " ";
    static char space2[2+1] = "  ";
    ...
    /* Builtin functions */
    double asin();
    integer i_indx(), f_rew(), s_rsfe(), do_fio(), e_rsfe(), s_wsfe(), e_wsfe(
	    );
...
#define keys ((char *)&keywrd_1)
    ...
    static doublereal sumx, sumy, sumz, c__[1];
    ...
    extern /* Subroutine */ int getsym_();
    static doublereal convtr, convrt;
    extern /* Subroutine */ int gettxt_(), gmetry_(), makpol_(), wrtkey_(), 
	    xyzint_(), symtry_(), symtrz_(), wrttxt_();
...
ICAL:  ',     F7.3,2X,F7.3,/,' THIS IS NOT ALLOWED IN A PATH CALCULATION')", 
	    0 };
...
N, AND SYMMETRY'   ,/10X,' SPECIFIED, BUT CALCULATION TO BE RUN IN CARTESIAN\
 '     ,'COORDINATES')", 0 };
    static cilist io___68 = { 0, 6, 0, "(//10X,' INTERNAL COORDINATES READ I\
N, AND',           ' CALCULATION ',/10X,'TO BE RUN IN CARTESIAN COORDINATES,\
 ',  /10X,'BUT NOT ALL COORDINATES MARKED FOR OPTIMISATION')", 0 };
    static cilist io___69 = { 0, 6, 0, "(//10X,' THIS INVOLVES A LOGICALLLY \
ABSURD CHOICE',/10X,' SO THE CALCULATION IS TERMINATED AT THIS POINT')", 0 };
    static cilist io___73 = { 0, 6, 0, "(//10X,' CARTESIAN COORDINATES READ \
IN, AND SYMMETRY'  ,/10X,' SPECIFIED, BUT CALCULATION TO BE RUN IN INTERNAL \
'      ,'COORDINATES')", 0 };
    static cilist io___74 = { 0, 6, 0, "(//10X,' CARTESIAN COORDINATES READ \
IN, AND',          ' CALCULATION ',/10X,'TO BE RUN IN INTERNAL COORDINATES, \
',   /10X,'BUT NOT ALL COORDINATES MARKED FOR OPTIMISATION')", 0 };
    static cilist io___75 = { 0, 6, 0, "(//10X,'MOPAC, BY DEFAULT, USES INTE\
RNAL COORDINATES',/10X,'TO SPECIFY CARTESIAN COORDINATES USE KEY-WORD :XYZ:')"
	    , 0 };
    static cilist io___76 = { 0, 6, 0, "(10X,'YOUR CURRENT CHOICE OF KEY-WOR\
DS INVOLVES' ,' A LOGICALLLY',/10X,'ABSURD CHOICE SO THE CALCULATION IS',  '\
 TERMINATED AT THIS POINT')", 0 };
