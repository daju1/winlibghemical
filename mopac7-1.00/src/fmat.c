/* fmat.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int fmat_(fmatrx, nreal, tscf, tder, deldip, heat)
doublereal *fmatrx;
integer *nreal;
doublereal *tscf, *tder, *deldip, *heat;
{
    /* Initialized data */
    ...
    /* Local variables */
    static doublereal grad[360], escf, eigs[360];
    static logical prnt;
    extern /* Subroutine */ int symr_();
    ...
    static integer ii;
    static doublereal heataa;
    static integer kk, ll, lu;
