/* deri22.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int deri22_(c__, b, work, norbs, foc2, ab, minear, fci)
doublereal *c__, *b, *work;
integer *norbs;
doublereal *foc2, *ab;
integer *minear;
doublereal *fci;
{
    ...
    static integer loop;
    extern /* Subroutine */ int mxmt_(), mtxm_(), fock1_(), fock2_();
    static integer i__, j, l;
#define w ((doublereal *)&wmatrx_1)
    static integer ninit, n1, n2, linear;
