/* geoutg.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int geoutg_(iprt)
integer *iprt;
{
    /* Initialized data */

    static char elemnt[2*107+1] = " HHeLiBe B C N O FNeNaMgAlSi P SClAr KCaS\
cTi VCrMnFeCoNiCuZnGaGeAsSeBrKrRbSr YZrNbMoTcRuRhPdAgCdInSnSbTe IXeCsBaLaCeP\
rNdPmSmEuGdTbDyHoErTmYbLuHfTa WReOsIrPtAuHgTlPbBiPoAtRnFrRaAcThPa UNpPuAmCmB\
kCfXXFmMdCb++ +-- -Tv";
    static char type__[1*3+1] = "rad";
    ...
    integer f_rew(), s_wsfe(), do_fio(), e_wsfe(), s_rsfe(), e_rsfe(), s_cmp()
	    ;
    ...
    static integer nopt, i__, j, l;
    static char blank[80];
    static doublereal degree;
    static char optdat[14*360];
    static integer maxtxt, nbi, nci;
    extern /* Subroutine */ int xxx_();
...
/* Subroutine */ int xxx_(type__, i__, j, k, l, r__, type_len, r_len)
char *type__;
integer *i__, *j, *k, *l;
char *r__;
ftnlen type_len;
ftnlen r_len;
{
    ...
    /* Local variables */
    static integer loop, m, i2, ii, ijk[4];
