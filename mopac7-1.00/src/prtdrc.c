/* prtdrc.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int prtdrc_(escf, deltt, xparam, ref, ekin, gtot, etot, 
	velo0, nvar)
doublereal *escf, *deltt, *xparam, *ref, *ekin, *gtot, *etot, *velo0;
integer *nvar;
{
    /* Initialized data */
    ...
    static char cotype[2*3+1] = "BLBADI";
    ...
    /* Builtin functions */
    integer i_indx(), s_wsfe(), do_fio(), e_wsfe(), s_rsle(), do_lio(), 
	    e_rsle(), s_wsle(), e_wsle();
    double sqrt(), d_sign();
