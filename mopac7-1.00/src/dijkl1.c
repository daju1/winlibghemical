/* dijkl1.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int dijkl1_(c__, n, nati, w, cij, wcij, ckl)
doublereal *c__;
integer *n, *nati;
doublereal *w, *cij, *wcij, *ckl;
{
    /* Initialized data */
    ...
    /* Local variables */
    static integer i__, j, k, l, na, ii, i77, ll, ip, iq, kr, js;
    extern /* Subroutine */ int formxy_();
    static integer nbi, nbj, ipq;
