...
/* Subroutine */ int frame_(fmat, numat, mode, shift)
doublereal *fmat;
integer *numat, *mode;
doublereal *shift;
{
    ...
    static doublereal sumw, a, b, c__;
    static integer i__, j, k, l;
    static doublereal x, y, z__;
    static integer n3;
    static doublereal coord1[360]	/* was [3][120] */, wtmass, vib[2160]	
	    /* was [6][360] */, rot[9]	/* was [3][3] */, sum, sum1, sum2, 
	    sum3, sum4, sum5, sum6;
