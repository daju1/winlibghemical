/* delri.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int delri_(dg, ni, nj, rr, del1)
doublereal *dg;
integer *ni, *nj;
doublereal *rr, *del1;
{
    ...
    /* Local variables */
    static doublereal term, dxdx, dzdz, qxxe, eqxx, qzze, eqzz, a0, dzqxx, 
	    qxxdz, dxqxz, qxzdx, dzqzz, qzzdz, da, db, ee, qa, qb, add, aee, 
	    ade, aed, qxxqxx, qxxqyy, qxxqzz, adq, aqe, aeq, aqd, qzzqxx, 
	    qzzqzz, qxzqxz, dze, edz, aqq;
