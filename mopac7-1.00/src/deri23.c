/* deri23.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int deri23_(f, fd, e, fci, cmo, emo, norbs)
doublereal *f, *fd, *e, *fci, *cmo, *emo;
integer *norbs;
{
