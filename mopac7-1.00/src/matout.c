/* matout.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int matout_(a, b, nc, nnr, ndim)
doublereal *a, *b;
integer *nc, *nnr, *ndim;
{
    /* Initialized data */

    static char atorbs[2*9+1] = " SPXPYPZX2XZZ2YZXY";
    ...
    /* Local variables */
    static integer i__, j, k, l, natom[420];
    static char itext[2*420], jtext[2*420];
    static integer ka, kb, kc, la, lc, lb, nr, jhi, jlo;
