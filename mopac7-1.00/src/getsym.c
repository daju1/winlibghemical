/* getsym.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int getsym_()
{
    /* Initialized data */

    static char text[60*18+1] = " BOND LENGTH    IS SET EQUAL TO THE REFEREN\
CE BOND LENGTH    BOND ANGLE     IS SET EQUAL TO THE REFERENCE BOND ANGLE   \
  DIHEDRAL ANGLE IS SET EQUAL TO THE REFERENCE DIHEDRAL ANGLE DIHEDRAL ANGLE\
 VARIES AS  90 DEGREES - REFERENCE DIHEDRAL   DIHEDRAL ANGLE VARIES AS  90 D\
EGREES + REFERENCE DIHEDRAL   DIHEDRAL ANGLE VARIES AS 120 DEGREES - REFEREN\
CE DIHEDRAL   DIHEDRAL ANGLE VARIES AS 120 DEGREES + REFERENCE DIHEDRAL   DI\
HEDRAL ANGLE VARIES AS 180 DEGREES - REFERENCE DIHEDRAL   DIHEDRAL ANGLE VAR\
IES AS 180 DEGREES + REFERENCE DIHEDRAL   DIHEDRAL ANGLE VARIES AS 240 DEGRE\
ES - REFERENCE DIHEDRAL   DIHEDRAL ANGLE VARIES AS 240 DEGREES + REFERENCE D\
IHEDRAL   DIHEDRAL ANGLE VARIES AS 270 DEGREES - REFERENCE DIHEDRAL   DIHEDR\
AL ANGLE VARIES AS 270 DEGREES - REFERENCE DIHEDRAL   DIHEDRAL ANGLE VARIES \
AS - REFERENCE DIHEDRAL               BOND LENGTH VARIES AS HALF THE REFEREN\
CE BOND LENGTH        BOND ANGLE VARIES AS HALF THE REFERENCE BOND ANGLE    \
      BOND ANGLE VARIES AS 180 DEGREES - REFERENCE BOND ANGLE     THE USER H\
AS TO SUPPLY THIS FUNCTION IN DEPVAR             ";
