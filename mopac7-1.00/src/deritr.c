/* deritr.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int deritr_(errfn, geo)
doublereal *errfn, *geo;
{
    /* Initialized data */
    ...
    /* Local variables */
    extern /* Subroutine */ int iter_();
    static doublereal xjuc[3];
    static integer i__, j, k, l;
    static logical debug;
#define w ((doublereal *)&wmatrx_1)
    extern /* Subroutine */ int hcore_();
    static doublereal coord[360]	/* was [3][120] */, aa, ee, change[3];
    static integer ij, ii, il, jl, kl, ll, idelta, linear;
