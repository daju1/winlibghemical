/* diat2.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int diat2_(na, esa, epa, r12, nb, esb, epb, s)
integer *na;
doublereal *esa, *epa, *r12;
integer *nb;
doublereal *esb, *epb, *s;
{
    /* Initialized data */
    ...
    static integer ii;
    static doublereal td, sroot3, rt3, rab;
    extern /* Subroutine */ int set_();
...
/* Subroutine */ int set_(s1, s2, na, nb, rab, ii)
doublereal *s1, *s2;
integer *na, *nb;
doublereal *rab;
integer *ii;
{
    ...
    extern /* Subroutine */ int aintgs_(), bintgs_();
