/* xyzint.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int xyzint_(xyz, numat, na, nb, nc, degree, geo)
doublereal *xyz;
integer *numat, *na, *nb, *nc;
doublereal *degree, *geo;
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int bangle_();
    static integer im1;
    extern /* Subroutine */ int xyzgeo_();
...
/* Subroutine */ int xyzgeo_(xyz, numat, na, nb, nc, degree, geo)
doublereal *xyz;
integer *numat, *na, *nb, *nc;
doublereal *degree, *geo;
{
...
/* Subroutine */ int bangle_(xyz, i__, j, k, angle)
doublereal *xyz;
integer *i__, *j, *k;
doublereal *angle;
{
    ...
    /* Local variables */
    static doublereal temp, xy, d2ij, d2ik, d2jk;
...
/* Subroutine */ int dihed_(xyz, i__, j, k, l, angle)
doublereal *xyz;
integer *i__, *j, *k, *l;
doublereal *angle;
{
    ...
    /* Local variables */
    extern /* Subroutine */ int dang_();
    static doublereal cosa, dist, cosph, costh, sinph, sinth, xi1, xj1, yi1, 
	    xl1, yj1, yl1, zi1, zj1, zl1, yxdist, xi2, xl2, yi2, yl2, yj2, 
	    yi3, yl3, ddd;
...
/* Subroutine */ int dang_(a1, a2, b1, b2, rcos)
doublereal *a1, *a2, *b1, *b2, *rcos;
{
    /* System generated locals */
    doublereal d__1, d__2;

    /* Builtin functions */
    double sqrt(), acos(), asin();
