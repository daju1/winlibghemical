/* mullik.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int mullik_(c__, h__, f, norbs, vecs, store)
doublereal *c__, *h__, *f;
integer *norbs;
doublereal *vecs, *store;
{
    ...
    integer i_indx();
    double sqrt();
    integer f_open(), s_wsue(), do_uio(), e_wsue();

    /* Local variables */
    static doublereal eigs[300];
    extern /* Subroutine */ int mult_();
    static doublereal summ;
    static integer i__, j, k, ifact[300];
    static logical graph;
    static doublereal bi, bj;
    static integer if__, jf, ii, ij, il, jl, jj;
    extern /* Character */ VOID getnam_();
    static integer linear;
    extern /* Subroutine */ int densit_(), vecprt_();
    static integer im1;
    extern /* Subroutine */ int gmetry_(), rsp_();
