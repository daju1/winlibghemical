/* partxy.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int partxy_(c34, pq34)
doublereal *c34, *pq34;
{
    /* Initialized data */
    ...
    /* Local variables */
    static integer indx[120];
    static doublereal ptot[120];
    static integer i__, jband, nband;
#define w ((doublereal *)&wmatrx_1)
    static integer ijold, ipqrs;
