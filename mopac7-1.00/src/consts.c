/* consts.f -- translated by f2c (version 19991025).
...
doublereal *coord;
{
    ...
    /* Local variables */
    static integer nara, nari, narj, info, jmax;
    static doublereal sdis, dist;
    static integer ipiv[400], nset[64920];
    static logical isup;
    static doublereal sdis0, dist1, dist2, dist3;
    static integer i__;
    static doublereal fdiag;
    static integer j, k, l;
    static doublereal r__;
    static integer narea;
    static doublereal x;
    static integer nsetf[400], inset, i0, j1, j2, n0[2];
...
/* DECK MOPAC */
    ...
    n0[0] = solv_1.nps2;
    n0[1] = -solv_1.nps;
    maxnps = sqrt((float)324000.25099999999) - solv_1.nden - (float).5;
