/* matou1.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int matou1_(a, b, ncx, nr, ndim, iflag)
doublereal *a, *b;
integer *ncx, *nr, *ndim, *iflag;
{
    /* Initialized data */

    static char xyz[2*3+1] = " x y z";
    static char atorbs[2*9+1] = "S PxPyPzx2xzz2yzxz";
    ...
    /* Local variables */
    static integer nfix, i__, j, k, l, nsave, natom[360];
    static char itext[2*360], jtext[2*360];
    static integer ka, kb, kc, la, lc, nc, lb;
