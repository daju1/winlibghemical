/* polar.f -- translated by f2c (version 19991025).
...
OR A FREQUENCY OF \002,f10.5,\002 EV  =\002,f14.5,\002 A.U. \002/18x,\002WAV\
ELENGTH OF \002,f10.2,\002 NM  =\002,f14.5,\002 CM(-1)\002,/,\002 \002,70\
(\002*\002))";
    ...
    integer i_indx(), s_wsfe(), e_wsfe(), do_fio(), s_rsfe(), e_rsfe();

    /* Local variables */
    static doublereal grad[360];
    ...
    static doublereal sumw, sumx, sumy, sumz, heat0, a, b, c__;
    static integer i__, j, k, l;
    extern /* Subroutine */ int betaf_();
    static integer iwfla, iwflb;
    extern /* Subroutine */ int ngoke_();
    static integer nfreq;
    static doublereal value[40], atpol, tempv[9]	/* was [3][3] */;
    extern /* Subroutine */ int nonor_();
#define ir ((integer *)&chanel_1 + 4)
    extern /* Subroutine */ int alphaf_();
#define iw ((integer *)&chanel_1 + 5)
    static doublereal dataev[10];
    extern /* Subroutine */ int compfg_(), nuchar_();
    static integer maxita, nvalue;
    extern /* Subroutine */ int openda_();
    ...
    extern /* Subroutine */ int nonope_(), nonbet_(), beopor_(), ngamtg_(), 
	    ngefis_(), ngidri_();
    static logical let;
...
/* Subroutine */ int tf_(ua, ga, ub, gb, t, norbs, nclose, iwflb)
doublereal *ua, *ga, *ub, *gb, *t;
integer *norbs, *nclose, *iwflb;
{
    /* System generated locals */
...
/* Subroutine */ int transf_(f, g, c__, norb)
doublereal *f, *g, *c__;
integer *norb;
{
    /* System generated locals */
...
doublereal trsub_(ul, x, ur, l1, lm, ndim)
doublereal *ul, *x, *ur;
integer *l1, *lm, *ndim;
{
    /* System generated locals */
...
doublereal trudgu_(ul, x, ur, l1, lm, ndim)
doublereal *ul, *x, *ur;
integer *l1, *lm, *ndim;
{
    /* System generated locals */
...
doublereal trugdu_(ul, x, ur, l1, lm, ndim)
doublereal *ul, *x, *ur;
integer *l1, *lm, *ndim;
{
    /* System generated locals */
...
doublereal trugud_(ul, x, ur, l1, lm, ndim)
doublereal *ul, *x, *ur;
integer *l1, *lm, *ndim;
{
    /* System generated locals */
...
/* Subroutine */ int alphaf_(iwfla, atol, maxita, u, f, g, uold, h1, d__, da)
integer *iwfla;
doublereal *atol;
integer *maxita;
doublereal *u, *f, *g, *uold, *h1, *d__, *da;
{
    /* Initialized data */

    static char alab[1*3+1] = "XYZ";

    /* Format strings */
    static char fmt_10[] = "(/,\002 +++++ ALPHA AT \002,1f13.5,\002 EV.\002)";
    static char fmt_30[] = "(/\002 CONVERGED IN\002,i4,\002 ITERATIONS IN\
\002,f10.2,\002 SECONDS\002,/\002           DENSITY CONVERG. TO \002,1pd12.5\
,/\002             ALPHA CONVERG. TO \002,1pd12.5,/)";
...
,\002 A.U.\002)";
    ...
    extern doublereal aval_();
    extern /* Subroutine */ int hmuf_();
    static logical last;
    static integer nsqr;
    extern /* Subroutine */ int densf_();
    static integer nnorb, iposg;
    extern /* Subroutine */ int copym_(), zerom_();
    static integer iposu;
    extern /* Subroutine */ int ffreq1_(), ffreq2_();
    static integer ic, id;
#define iw ((integer *)&chanel_1 + 5)
    static doublereal allalp[9]	/* was [3][3] */, alpavg;
    extern doublereal second_();
    static doublereal alpold;
    extern /* Subroutine */ int makeuf_();
    static doublereal alphaw, cmptim;
    extern /* Subroutine */ int dawrit_(), transf_();
    static integer icount;
    extern /* Subroutine */ int hplusf_();
...
doublereal aval_(h__, d__, norbs)
doublereal *h__, *d__;
integer *norbs;
{
    /* System generated locals */
...
/* Subroutine */ int bdensf_(ua, ub, uab, c__, d__, da, norbs, nclose, iwflb)
doublereal *ua, *ub, *uab, *c__, *d__, *da;
integer *norbs, *nclose, *iwflb;
{
    /* System generated locals */
...
/* Subroutine */ int beopor_(iwflb, maxitu, btol, ua, ub, f, ga, gb, t, h1, 
	d__, da, uab, uold1, g, x)
integer *iwflb, *maxitu;
doublereal *btol, *ua, *ub, *f, *ga, *gb, *t, *h1, *d__, *da, *uab, *uold1, *
	g, *x;
{
    /* Initialized data */
...
a1,\002) = \002,1f15.5)";
 ...
 EV = \002,1f15.5,//)";
    ...
    extern /* Subroutine */ int daread_(), tf_();
#define iw ((integer *)&chanel_1 + 5)
    extern /* Subroutine */ int bdensf_(), bmakuf_();
    static doublereal betold;
    extern doublereal second_();
    extern /* Subroutine */ int fhpatn_();
    static doublereal cmptim;
    extern /* Subroutine */ int dawrit_(), transf_(), hplusf_();
    static integer icount, iposum, jpg;
...
/* Subroutine */ int betaf_(iwflb, maxitu, btol, ua, ub, f, ga, gb, t, h1, 
	d__, da, uab, uold1, g, x)
integer *iwflb, *maxitu;
doublereal *btol, *ua, *ub, *f, *ga, *gb, *t, *h1, *d__, *da, *uab, *uold1, *
	g, *x;
...
,\002 EV = \002,1f11.5,//)";
    ...
    extern /* Subroutine */ int daread_(), tf_();
#define iw ((integer *)&chanel_1 + 5)
    extern /* Subroutine */ int bdensf_();
    static doublereal allbet[27]	/* was [3][3][3] */;
    extern /* Subroutine */ int bmakuf_();
    static doublereal betold;
    extern doublereal second_();
    extern /* Subroutine */ int fhpatn_();
    static doublereal cmptim;
...
/* Subroutine */ int betal1_(u0a, g0a, u1b, g1b, u1c, g1c, nclose, norbs, 
	term)
doublereal *u0a, *g0a, *u1b, *g1b, *u1c, *g1c;
integer *nclose, *norbs;
doublereal *term;
{
    /* System generated locals */
    ...
    /* Local variables */
    static doublereal t1a;
    extern doublereal trugud_();
    static doublereal t2a;
    extern doublereal trudgu_();
    static doublereal t3a;
    extern doublereal trugdu_();
    static doublereal t4a, t5a, t6a, t1b, t2b, t3b, t4b, t5b, t6b;
...
/* Subroutine */ int betall_(u2a, g2a, u1b, g1b, u1c, g1c, nclose, norbs, 
	term)
doublereal *u2a, *g2a, *u1b, *g1b, *u1c, *g1c;
integer *nclose, *norbs;
doublereal *term;
{
    /* System generated locals */
    ...
    /* Local variables */
    static doublereal t1a, t2a;
    extern doublereal trudgu_(), trugud_();
    static doublereal t3a, t4a, t5a;
    extern doublereal trugdu_();
    static doublereal t6a, t1b, t2b, t3b, t4b, t5b, t6b;
...
/* Subroutine */ int betcom_(u1, g1, u2, g2, nclose, norbs, term)
doublereal *u1, *g1, *u2, *g2;
integer *nclose, *norbs;
doublereal *term;
{
    /* System generated locals */
    ...
    /* Local variables */
    static doublereal t1a, t2a, t3a, t1b;
    extern doublereal trudgu_(), trugud_(), trugdu_();
    static doublereal t2b, t3b;
...
/* Subroutine */ int bmakuf_(ua, ub, uab, t, uold1, gab, eigs, last, norbs, 
	nclose, diff, iwflb, maxu, btol)
doublereal *ua, *ub, *uab, *t, *uold1, *gab, *eigs;
logical *last;
integer *norbs, *nclose;
doublereal *diff;
integer *iwflb;
doublereal *maxu, *btol;
{
    /* System generated locals */
...
/* Subroutine */ int darea1_(v, len, idaf, ns)
doublereal *v;
integer *len, *idaf, *ns;
{
    /* System generated locals */
...
/* Subroutine */ int daread_(v, len, nrec)
doublereal *v;
integer *len, *nrec;
{
    /* Format strings */
...
ORD\002,\002 THAT WAS NEVER WRITTEN. NREC,LEN=\002,i5,i10)";
    ...
    /* Local variables */
    static integer lent, lenw, n;
    extern /* Subroutine */ int darea1_();
    static integer if__, is;
#define iw ((integer *)&chanel_1 + 5)
    static integer ns, nsp;
...
/* Subroutine */ int dawrit_(v, len, nrec)
doublereal *v;
integer *len, *nrec;
{
    /* Format strings */
    static char fmt_40[] = "(1x,\002DAWRIT HAS REQUESTED A RECORD WITH LEN\
GTH\002,1x,\002DIFFERENT THAN BEFORE - ABORT FORCED.\002/1x,\002DAF RECORD\
 \002,i5,\002 NEW LENGTH =\002,i5,\002 OLD LENGTH =\002,i5)";

    /* Builtin functions */
    integer s_wdue(), do_uio(), e_wdue(), s_wsfe(), do_fio(), e_wsfe();
    /* Subroutine */ int s_stop();

    /* Local variables */
    static integer lent, lenw, n;
    extern /* Subroutine */ int dawrt1_();
    static integer if__, is;
#define iw ((integer *)&chanel_1 + 5)
    static integer ns;
    static logical newrec;
    static integer ipk, ist, nsp;
...
/* Subroutine */ int dawrt1_(v, len, idaf, ns)
doublereal *v;
integer *len, *idaf, *ns;
{
    /* System generated locals */
...
/* Subroutine */ int densf_(u, c__, ca, d__, da, norbs, nclose)
doublereal *u, *c__, *ca, *d__, *da;
integer *norbs, *nclose;
{
    /* System generated locals */
...
/* Subroutine */ int epsab_(eigsab, eigs, gab, ga, gb, ua, ub, uab, udms, 
	norbs, nclose, iwflb)
doublereal *eigsab, *eigs, *gab, *ga, *gb, *ua, *ub, *uab, *udms;
integer *norbs, *nclose, *iwflb;
{
    /* System generated locals */
...
/* Subroutine */ int ffreq1_(f, ptot, pa, pb, ndim)
doublereal *f, *ptot, *pa, *pb;
integer *ndim;
{
    /* Initialized data */
    ...
    static integer ia, ib, ic, ii, ni, iminus, icc;
...
/* Subroutine */ int ffreq2_(f, ptot, w, numat, nfirst, nlast, norbs)
doublereal *f, *ptot, *w;
integer *numat, *nfirst, *nlast, *norbs;
{
    /* System generated locals */
...
/* Subroutine */ int fhpatn_(a, b, norbs, itw, sign)
doublereal *a, *b;
integer *norbs, *itw;
doublereal *sign;
{
...
/* Subroutine */ int hmuf_(h1, id, coord, nfirst, nlast, nat, norbs, numat)
doublereal *h1;
integer *id;
doublereal *coord;
integer *nfirst, *nlast, *nat, *norbs, *numat;
{
    /* System generated locals */
    ...
    extern /* Subroutine */ int zerom_();
    static integer ia, ib, ni, io1, jo1;
...
/* Subroutine */ int hplusf_(f, h__, norbs)
doublereal *f, *h__;
integer *norbs;
{
    /* System generated locals */
...
/* Subroutine */ int makeuf_(u, uold, g, eigs, last, norbs, nnorbs, nclose, 
	diff, atol)
doublereal *u, *uold, *g, *eigs;
logical *last;
integer *norbs, *nnorbs, *nclose;
doublereal *diff, *atol;
{
    /* System generated locals */
...
/* Subroutine */ int ngamtg_(igam, x, gd3, ud3, g1, u1, gs, usmd, eps, us)
integer *igam;
doublereal *x, *gd3, *ud3, *g1, *u1, *gs, *usmd, *eps, *us;
{
    /* Initialized data */
...
,\002,\002,a1,\002) = \002,1f13.5)";
 ...
 = \0021f13.5,//)";
    ...
    static integer jgarc, jgrec, juarc, jurec, imove, j2;
    extern doublereal trsub_();
    static integer jg2rec, ju2rec, ju2mrc, ia, ib, ic, id, ie;
    extern /* Subroutine */ int daread_();
    static integer j34;
#define iw ((integer *)&chanel_1 + 5)
...
/* Subroutine */ int ngefis_(igam, x, gd3, ud3, g1, u1, gs, usmd, eps, us)
integer *igam;
doublereal *x, *gd3, *ud3, *g1, *u1, *gs, *usmd, *eps, *us;
{
    /* Initialized data */
...
/* Subroutine */ int ngidri_(igam, x, gd3, ud3, g1, u1, gs, usmd, eps, us)
integer *igam;
doublereal *x, *gd3, *ud3, *g1, *u1, *gs, *usmd, *eps, *us;
{
    /* Initialized data */
...
#define iw ((integer *)&chanel_1 + 5)
    extern /* Subroutine */ int fhpatn_();
    static doublereal yy;
    static integer jeprec, icd, ibd, ibc;
    static doublereal gav, one;
    static integer msq;
...
/* Subroutine */ int ngoke_(igam, x, gd3, ud3, g1, u1, gs, usmd, eps, us)
integer *igam;
doublereal *x, *gd3, *ud3, *g1, *u1, *gs, *usmd, *eps, *us;
{
    /* Initialized data */
...
/* Subroutine */ int nonbet_(u1x, u1y, u1z, u2x, u2y, u2z, g1x, g1y, g1z, g2x,
	 g2y, g2z)
doublereal *u1x, *u1y, *u1z, *u2x, *u2y, *u2z, *g1x, *g1y, *g1z, *g2x, *g2y, *
	g2z;
{
    /* Format strings */
...
.8,\002  BZXX \002,d15.8,/,\002  BXXY  \002,d15.8,\002  BYXY \002,d15.8,\002\
  BZXY \002,d15.8,/,\002  BXXZ  \002,d15.8,\002  BYXZ \002,d15.8,\002  BZXZ\
 \002,d15.8,/,\002  BXYX  \002,d15.8,\002  BYYX \002,d15.8,\002  BZYX \002,d\
15.8,/,\002  BXYY  \002,d15.8,\002  BYYY \002,d15.8,\002  BZYY \002,d15.8,/\
,\002  BXYZ  \002,d15.8,\002  BYYZ \002,d15.8,\002  BZYZ \002,d15.8,/,\002  \
BXZX  \002,d15.8,\002  BYZX \002,d15.8,\002  BZZX \002,d15.8,/,\002  BXZY \
 \002,d15.8,\002  BYZY \002,d15.8,\002  BZZY \002,d15.8,/,\002  BXZZ  \002,d\
15.8,\002  BYZZ \002,d15.8,\002  BZZZ \002,d15.8)";
...
,\002EV = \002,1f15.5,//)";
    ...
    extern /* Subroutine */ int daread_();
#define iw ((integer *)&chanel_1 + 5)
    extern /* Subroutine */ int betall_(), betcom_();
...
/* Subroutine */ int nonope_(u0x, u1y, u1z, u1x, u0y, u0z, g0x, g1y, g1z, g1x,
	 g0y, g0z)
doublereal *u0x, *u1y, *u1z, *u1x, *u0y, *u0z, *g0x, *g1y, *g1z, *g1x, *g0y, *
	g0z;
{
    /* Format strings */
...
/* Subroutine */ int nonor_(u0x, u1y, u1z, u1x, u0y, u0z, g0x, g1y, g1z, g1x, 
	g0y, g0z)
doublereal *u0x, *u1y, *u1z, *u1x, *u0y, *u0z, *g0x, *g1y, *g1z, *g1x, *g0y, *
	g0z;
{
...
,\002EV = \002,1f15.5,//)";
    ...
    static doublereal bvec, bavx, bavy, bavz, bxxx, byxx, bzxx, bxxy, byxy, 
	    ...
	    byyz, bzyz, bxzx, byzx, bzzx, bxzy, byzy, bzzy, bxzz, byzz, bzzz;
    static integer maxsq;
    extern /* Subroutine */ int betal1_(), daread_();
#define iw ((integer *)&chanel_1 + 5)
...
integer *irest;
{
    ...
    /* Builtin functions */
    integer f_open(), s_wdue(), do_uio(), e_wdue(), s_rdue(), e_rdue();
