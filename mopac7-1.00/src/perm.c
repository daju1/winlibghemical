/* perm.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int perm_(iperm, nels, nmos, maxmos, nperms)
integer *iperm, *nels, *nmos, *maxmos, *nperms;
{
    ...
    /* Local variables */
    static integer iadd[20], i__, j, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, 
	    i11, i12, nel[20];
