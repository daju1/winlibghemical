/* initsv.f -- translated by f2c (version 19991025).
...
integer *indeps;
{
    ...
    static integer n;
    static doublereal x, delsc, disex;
#define dirsm ((doublereal *)&solv_1 + 1325)
    static integer i4;
    static doublereal rsolv, x0, z3, z4;
#define iw ((integer *)&chanel_1 + 5)
    static integer indels, indise;
    extern /* Subroutine */ int dvfill_();
