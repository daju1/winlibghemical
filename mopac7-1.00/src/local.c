/* local.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int local_(c__, mdim, nocc, eig)
doublereal *c__;
integer *mdim, *nocc;
doublereal *eig;
{
    ...
    static char elemnt[2*99+1] = "H HELIBEB C N O F NENAMGALSIP S CLARK CASC\
TIV CRMNFECONICUZNGAGEASSEBRKRRBSRY ZRNBMOTCRURHPDAGCDINSNSBTEI XECSBALACEPR\
NDPMSMEUGDTBDYHOERTMYBLUHFTAW REOSIRPTAUHGTLPBBIPOATRNFRRAACTHPAU NPPUAMCMBK\
CFXX";
...
ION OF ORBITALS)\002//)";
    ...
    static doublereal x, xiiii, xjiii, xijij, xijjj, xjjjj;
    static integer niter;
    static doublereal xiijj;
    static integer i1, k1;
    static doublereal ca, co;
    static integer ii;
    static doublereal sa;
    static integer il, kl, iu, ku;
    static doublereal refeig[300];
