/* ffhpol.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int ffhpol_(heat0, atpol)
doublereal *heat0, *atpol;
{
    /* Initialized data */

    static integer iptbd[6] = { 5,7,4,9,6,8 };
    static char axis[1*3+1] = "XYZ";
...
,/,\002   - \002,2(f20.10,3x),/,\002  DIPOLE:\002/,\002   + \002,2(f20.10,3x\
),/,\002   - \002,2(f20.10,3x))";
...
4\002,13x,\002DIP\002,/,\002 \002,24x,2f15.6,\002  A.U.\002,/,\002 \002,24x,\
2f15.6,\002  ANG.**3\002,/,\002 \002,24x,2(1pd15.6),\002  ESU\002)";
...
,\002 \002,4x,\002B(ESU)\002,4x,2f12.3,7x,2f12.3,\002 (X10-30)\002)";
...
1pd12.5,\002  A.U.\002/,\002 \002,8x,1pd12.5,1pd12.5,5x,1pd12.5,1pd12.5,\002\
  ESU (X10-36)\002)";
    ...
    /* Local variables */
    static doublereal grad[360], bkii, bjii, bijj, diim, gdip;
    static integer idip;
    ...
    extern /* Subroutine */ int compfg_(), dipind_();
    static doublereal apoldp[6], autodb, dipdpt, autokc, avgesu, avgpdp, 
	    avgesd, gamval, gamesu, autovm, bx4, by4, bz4;
    static integer nbd;
