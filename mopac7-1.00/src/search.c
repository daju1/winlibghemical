/* search.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int search_(xparam, alpha, sig, nvar, gmin, okf, funct)
doublereal *xparam, *alpha, *sig;
integer *nvar;
doublereal *gmin;
logical *okf;
doublereal *funct;
{
    ...
    /* Local variables */
    static doublereal grad[360], gref[360], xref[360], gtot;
    static logical nopr;
    static doublereal tiny, xmin1[360], g;
    static integer i__;
