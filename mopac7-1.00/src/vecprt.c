/* vecprt.f -- translated by f2c (version 19991025).
...
integer *numm;
{
    ...
    static integer numb, i__, j, k, l, m, n, natom[300], limit;
    static char itext[2*300], jtext[2*300];
    static integer ma, na, kk, ll, jhi, jlo;
