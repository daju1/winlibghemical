/* analyt.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int analyt_(psum, palpha, pbeta, coord, nat, jja, jjd, iia, 
	iid, eng)
doublereal *psum, *palpha, *pbeta, *coord;
integer *nat, *jja, *jjd, *iia, *iid;
doublereal *eng;
{
    /* Initialized data */
    ...
    /* Local variables */
    static doublereal enuc[3];
    extern /* Subroutine */ int ders_();
    static doublereal anam1, alph1, alph2, part1, part2, part3;
    static integer i__, j, k, l, m, n;
    static doublereal alpha;
    extern /* Subroutine */ int delri_();
    static integer nbond;
    static doublereal a0, termk, terml, c1, c2, c3, f3;
    static integer i1, j1;
    static doublereal r0, r2;
    static logical mindo3;
    static doublereal aa, bb, dd;
    static integer ia;
    static doublereal bi[4], bj[4];
    static integer jd, ja, id, ka, kg, la, lg, ni, nj, is, i22, ii, ig, lk, 
	    mn;
    static doublereal rr;
    static integer jj;
    static doublereal termaa, termab;
    extern /* Subroutine */ int delmol_();
    static integer ij, kk;
    static doublereal termnc;
    static integer ll;
    static logical am1;
    static integer kl, mk, nk, istart, jstart;
    static doublereal dr1;
    static integer ml, nl;
    static doublereal eaa[3], eab[3];
    static integer iol;
    static doublereal rij;
    static integer isp;
    static doublereal del1, del2, del3, exp1, exp2;
