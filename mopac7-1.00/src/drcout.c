/* drcout.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int drcout_(xyz3, geo3, vel3, nvar, time, escf3, ekin3, 
	gtot3, etot3, xtot3, iloop, charge, fract, text1, text2, ii, jloop, 
	text1_len, text2_len)
doublereal *xyz3, *geo3, *vel3;
integer *nvar;
doublereal *time, *escf3, *ekin3, *gtot3, *etot3, *xtot3;
integer *iloop;
doublereal *charge, *fract;
char *text1, *text2;
integer *ii, *jloop;
ftnlen text1_len;
ftnlen text2_len;
{
    ...
    /* Builtin functions */
    integer i_indx(), s_cmp(), s_wsfe(), e_wsfe(), do_fio(), s_wsle(), do_lio(
	    ), e_wsle();
    ...
    static integer ll, iprint, prtkom, prtkey, prtitl;
    static logical drc;
...
+'          ,' KINETIC  =  TOTAL     ERROR    REF%   MOVEMENT')", 0 };
    static cilist io___10 = { 0, 6, 0, "(//,'     POINT   POTENTIAL  +  '   \
             ,'ENERGY LOST   =   TOTAL      ERROR    REF%   MOVEMENT')", 0 };
