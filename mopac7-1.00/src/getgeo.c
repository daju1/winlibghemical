/* getgeo.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int getgeo_(iread, labels, geo, lopt, na, nb, nc, ams, 
	natoms, int__)
integer *iread, *labels;
doublereal *geo;
integer *lopt, *na, *nb, *nc;
doublereal *ams;
integer *natoms;
logical *int__;
{
    ...
    static char elemnt[2*107+1] = "H HELIBEB C N O F NENAMGALSIP S CLARK CAS\
CTIV CRMNFECONICUZNGAGEASSEBRKRRBSRY ZRNBMOTCRURHPDAGCDINSNSBTEI XECSBALACEP\
RNDPMSMEUGDTBDYHOERTMYBLUHFTAW REOSIRPTAUHGTLPBBIPOATRNFRRAACTHPAU NPPUAMCMB\
KCFXXFMMDCB+++ --- TV";
    static char comma[1+1] = ",";
    static char space[1+1] = " ";
    static char nine[1+1] = "9";
    static char zero[1+1] = "0";
    ...
    integer s_rsfe(), do_fio(), e_rsfe(), s_cmp();
    /* Subroutine */ int s_cat();
    integer s_wsfe(), e_wsfe();
    /* Subroutine */ int s_stop();
    double sqrt(), d_sign(), asin();
    ...
    static integer icapa, l, label, iline, icapz, ilowa;
...
PARAMETER HAS',/10X,' BEEN MARKED FOR OPTIMIZATION. THIS IS A NON-FATAL '   \
 ,'ERROR')", 0 };
