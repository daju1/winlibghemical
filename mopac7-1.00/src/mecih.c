/* mecih.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int mecih_(diag, cimat, nmos, lab)
doublereal *diag, *cimat;
integer *nmos, *lab;
{
    ...
    /* Local variables */
    static integer j;
    extern doublereal aababc_(), aabacd_(), aabbcd_(), babbcd_(), babbbc_();
    static integer ik, ix, iy;
