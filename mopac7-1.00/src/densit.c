/* densit.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int densit_(c__, mdim, norbs, ndubl, nsingl, fract, p, mode)
doublereal *c__;
integer *mdim, *norbs, *ndubl, *nsingl;
doublereal *fract, *p;
integer *mode;
{
    ...
    /* Local variables */
    static doublereal frac, sign;
    static integer i__, j, k, l;
    static doublereal const__;
    static integer norbs2, nl1, nl2, nu1, nu2;
