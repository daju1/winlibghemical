/* linmin.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int linmin_(xparam, alpha, pvect, nvar, funct, okf, ic, dott)
doublereal *xparam, *alpha, *pvect;
integer *nvar;
doublereal *funct;
logical *okf;
integer *ic;
...
8,2f17.11/5x,\002CENTER ...\002,f17.8,2f17.11,/5x,\002RIGHT  ...\002,f17.8,2\
f17.11,/)";
    static char fmt_130[] = "(5x,\002LEFT    ...\002,f17.8,2f17.11,/5x,\002C\
ENTER  ...\002,f17.8,2f17.11,/5x,\002RIGHT   ...\002,f17.8,2f17.11,/5x,\002N\
EW     ...\002,f17.8,2f17.11,/)";
    ...
    /* Local variables */
    static doublereal beta, grad[360], pabs, alfs;
    static logical diis;
