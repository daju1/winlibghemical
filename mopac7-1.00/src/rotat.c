/* rotat.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int rotat_(coord, i__, j, ix, rij, del1, idx)
doublereal *coord;
integer *i__, *j, *ix;
doublereal *rij, *del1;
integer *idx;
{
    ...
    /* Local variables */
    static doublereal term, xd, yd, zd;
    static integer ijk;
    static doublereal rxy, rzx, ryz;
