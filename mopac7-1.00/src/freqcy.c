/* freqcy.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int freqcy_(fmatrx, freq, cnorml, redmas, travel, eorc, 
	deldip)
doublereal *fmatrx, *freq, *cnorml, *redmas, *travel;
logical *eorc;
doublereal *deldip;
{
    /* Initialized data */
