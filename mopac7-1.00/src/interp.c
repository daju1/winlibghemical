/* interp.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int interp_(n, np, nq, mode, e, fp, cp, vec, fock, p, h__, 
	vecl)
integer *n, *np, *nq, *mode;
doublereal *e, *fp, *cp, *vec, *fock, *p, *h__, *vecl;
{
    /* Initialized data */
...
/DX \002,\002   ROTATION (DEGREES)\002,/\002      OLD \002,f10.5,3f15.10,\
/\002  CURRENT \002,f10.5,3f15.10,/\002 PREDICTED\002,f10.5,3f15.10/)";
    ...
    double sqrt(), asin(), cos(), sin();

    /* Local variables */
    static doublereal eold, dedx, rold, rmin, xold, enow, rnow, xnow;
    static integer i__, j, k;
    static logical debug;
    static doublereal deold, theta[300];
    extern /* Subroutine */ int hqrii_();
    static doublereal denow;
    static integer minpq, i1, j1, k1, k2;
    static doublereal ck;
    static integer ii, ik, ij, il;
    static doublereal sk;
    extern /* Subroutine */ int schmib_(), schmit_(), spline_();
    static integer ipoint, np1, np2;
...
/* Subroutine */ int spline_()
{
    ...
    static integer n1;
    static doublereal x1, x2, xstop, bb, fm, dx, xk, ac3, xstart, dum;
...
/* Subroutine */ int schmit_(u, n, ndim)
doublereal *u;
integer *n, *ndim;
{
    /* Initialized data */
...
/* Subroutine */ int schmib_(u, n, ndim)
doublereal *u;
integer *n, *ndim;
{
    /* Initialized data */
...
/* Subroutine */ int pulay_(f, p, n, fppf, fock, emat, lfock, nfock, msize, 
	start, pl)
doublereal *f, *p;
integer *n;
doublereal *fppf, *fock, *emat;
integer *lfock, *nfock, *msize;
logical *start;
doublereal *pl;
{
    /* Initialized data */
    ...
    /* Local variables */
    static doublereal evec[1000], d__;
    static integer i__, j, l;
    static logical debug;
    static integer lbase, mfock;
    static doublereal const__;
    extern /* Subroutine */ int osinv_();
    static integer nfock1, ii, il;
    static doublereal coeffs[20];
    static integer linear, maxlim;
    extern /* Subroutine */ int mamult_();
...
doublereal *d__;
{
    ...
    /* Local variables */
    static doublereal biga, holo;
    static integer i__, j, k, l[300], m[300], ij, ki, kk, ji, jk, nk, jp, ik, 
	    kj, jq, jr, iz;
