/* locmin.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int locmin_(m, x, n, p, ssq, alf, efs, itrap, escf)
integer *m;
doublereal *x;
integer *n;
doublereal *p, *ssq, *alf, *efs;
integer *itrap;
doublereal *escf;
{
    /* Initialized data */
...
6/5x,\002CENTER ...\002,2f19.6/5x,\002RIGHT  ...\002,2f19.6/\002 \002)";
    static char fmt_320[] = "(5x,\002LEFT   ...\002,2f19.6/5x,\002CENTER ..\
.\002,2f19.6/5x,\002RIGHT  ...\002,2f19.6/5x,\002NEW    ...\002,2f19.6/\002\
 \002)";
    ...
    /* Local variables */
    static doublereal beta, alfs;
    static integer left, ictr, mxct;
    static doublereal f;
    static integer i__;
    static doublereal gamma, s, t, alpha;
    ...
    extern /* Subroutine */ int compfg_(), exchng_();
    static integer center;
    static doublereal energy;
    static char keywrd[241];
    static integer iprint;
    static doublereal ymaxst, sqstor, abg, fin, tee, phi[3];
    extern doublereal dot_();
    static doublereal eps, sum, sum2;
...
/*    TEST FOR EXCITED STATES AND POTHOLES */
	...
	*itrap = 0;
	...
	if (abs(t) / ((d__1 = vt[left - 1], abs(d__1)) + 1e-15) > (float)
		.3333) {
	    goto L200;
	}
