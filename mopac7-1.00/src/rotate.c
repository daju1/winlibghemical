...
/* Subroutine */ int rotate_(ni, nj, xi, xj, w, kr, e1b, e2a, enuc, cutoff)
integer *ni, *nj;
doublereal *xi, *xj, *w;
integer *kr;
doublereal *e1b, *e2a, *enuc, *cutoff;
{
    /* Initialized data */
