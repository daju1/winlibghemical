/* delmol.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int delmol_(coord, i__, j, ni, nj, ia, id, ja, jd, ix, rij, 
	tomb, isp)
doublereal *coord;
integer *i__, *j, *ni, *nj, *ia, *id, *ja, *jd, *ix;
doublereal *rij, *tomb;
integer *isp;
{
    ...
    extern /* Subroutine */ int rotat_();
    static integer ib, jb, kk, ll, mm, nn;
