/* dipole.f -- translated by f2c (version 19991025).
...
doublereal dipole_(p, q, coord, dipvec, mode)
doublereal *p, *q, *coord, *dipvec;
integer *mode;
{
    /* Initialized data */
...
#define hyf ((doublereal *)&equiv_18)
    ...
    static char fmt_130[] = "(\002 DIPOLE\002,11x,\002X         Y         Z \
      TOTAL\002,/,\002 POINT-CHG.\002,4f10.3/,\002 HYBRID\002,4x,4f10.3/,\
\002 SUM\002,7x,4f10.3)";
