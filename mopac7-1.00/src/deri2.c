/* deri2.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int deri2_(c__, e, norbs, minear, f, fd, fci, ninear, nvar, 
	work, b, nw2, grad, ab, nw3, fb, throld)
doublereal *c__, *e;
integer *norbs, *minear;
doublereal *f, *fd, *fci;
integer *ninear, *nvar;
doublereal *work, *b;
integer *nw2;
...
doublereal *fb, *throld;
{
    ...
    static cilist io___15 = { 0, 6, 0, "(' THE BAB MATRIX OF ORDER',I3,     \
       ...
       ' THE RELAXATION IS STOPPED AT THIS POINT.')", 0 };
    static cilist io___20 = { 0, 6, 0, 0, 0 };
    static cilist io___23 = { 0, 6, 0, "(' RELAXATION ENDED IN DERI2 AFTER',\
I3,                ' CYCLES'/' REQUIRED CONVERGENCE THRESHOLD ON RESIDUALS =\
'    ,F12.9/' HIGHEST RESIDUAL ON',I3,' GRADIENT COMPONENTS = '    ,F12.9)", 
	    0 };
...
E.V.)'/      '    I    J    K    L       d<I(1)J(1)|K(2)L(2)> RELAXATION ONL\
Y')                                                                ", 0 };
