/* anavib.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int anavib_(coord, eigs, dipt, n3, vibs, rij, hess, travel, 
	redmas)
doublereal *coord, *eigs, *dipt;
integer *n3;
doublereal *vibs, *rij, *hess, *travel, *redmas;
{
    /* Initialized data */
    ...
    static integer i1, j1, j3, j2, i3, i2;
    static doublereal ea, eb;
    static integer ii, ij, jj;
    static doublereal radial, xi, xj, yj, zj, yi;
    static integer linear;
    static doublereal zi, eab;
...
/* #            IF(ABS(E).GT.110)GOTO 120 */
	    ...
	    if (abs(e) > 10. || ij < 5 && abs(e) > (float).1) {
		shift = sqrt(shift);
/* Computing 2nd power */
