/* flepo.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int flepo_(xparam, nvar, funct1)
doublereal *xparam;
integer *nvar;
doublereal *funct1;
{
...
BE REPLACED BY VALUE=\002,f13.7,/10x,\002CALCULATED BY RESTART PROCEDURE\002\
,/)";
    static char fmt_110[] = "(\002 FUNCTION VALUE=\002,f13.7,\002 IS BEING R\
EPLACED BY VALUE=\002,f13.7,/10x,\002 FOUND IN RESTART PROCEDURE\002,/,6x\
,\002THE CORRESPONDING X VALUES AND GRADIENTS ARE ALSO BEING REPLACED\002,/)";
...
i5,\002  THE FUNCTION VA   LUE IS \002,f13.6/,\002  THE CURRENT POINT IS ..\
.\002)";
...
\002         COS    =\002,f11.4,/,\002  ABSOLUTE  CHANGE IN X     =\002,f13.\
6,\002  ALPHA  =\002,f11.4,/,\002  PREDICTED CHANGE IN F     =  \002,g11.4\
,\002  ACTUAL =  \002,g11.4,/,\002  GRADIENT NORM             =  \002,g11.4,\
//)";
...
TO REDUCE THE \002,\002 GRADIENT.\002,/10x,\002 DURING THESE ATTEMPTS THE EN\
ERGY DROPPED\002,\002 BY LESS THAN\002,f4.1,\002 KCAL/MOLE\002,/10x,\002 FUR\
THER CALCULATION IS NOT JUSTIFIED AT THIS TIME.\002,/10x,\002 TO CONTINUE, S\
TART AGAIN WITH THE WORD \"PRECISE\"\002)";
...
#define drop (equiv_11 + 3)
    ...
    static integer nrst, iinc1, iinc2, itry1, i__, j, k;
...
#define jnrst (equiv_3 + 1)
    ...
    extern /* Subroutine */ int scopy_(), geout_();
    static doublereal xvari, smval, rootv, dropn, bsmvf, totim, funct2, gd[
	    360], cncadd;
    static integer ic;
    static doublereal gg[360];
    static integer i80, ii;
    static doublereal tf, xd[360];
    static logical saddle;
    static doublereal deltag, delhof, xn, absmin;
...
#define lnstop (equiv_3 + 3)
    ...
    extern /* Subroutine */ int supdot_();
    static doublereal sy, pnlast;
    extern /* Subroutine */ int linmin_();
    static doublereal tx, tcycle, tx1, tx2, ggd;
...
OORDINATES ARE   ',/10X,' CAUSING A LARGE CHANGE IN THE DISTANCE BETWEEN',/ \
  10X,' CHEMICALLY-BOUND ATOMS. THE GEOMETRY OPTIMIZATION',/     10X,' PROCE\
DURE WOULD LIKELY PRODUCE INCORRECT RESULTS')", 0 };
...
,      'THAN THE STARTING POINT ',/,20X,'COULD BE FOUND ',           'IN THE\
 LINE MINIMIZATION')", 0 };
