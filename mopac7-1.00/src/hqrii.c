/* hqrii.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int hqrii_(a, n, m, e, v)
doublereal *a;
integer *n, *m;
doublereal *e, *v;
{
    ...
    static doublereal sinv, summ, c__, h__;
    static integer i__, j, k, l;
    static doublereal r__, s, t, u, w[1800]	/* was [5][360] */, z__;
