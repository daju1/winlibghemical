/* datin.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int datin_()
{
    /* Initialized data */

    static char numbrs[1*10+1] = " 123456789";
    static char partyp[5*25+1] = "USS  UPP  UDD  ZS   ZP   ZD   BETASBETAPBE\
TADGSS  GSP  GPP  GP2  HSP  AM1  EXPC GAUSSALP  GSD  GPD  GDD  FN1  FN2  FN3\
  ORB  ";
...
KCFXXFMMDCB+++ --- TV";
    ...
    integer s_wsfe(), e_wsfe(), f_open(), s_rsfe(), do_fio(), e_rsfe(), s_cmp(
	    );
    ...
    extern /* Subroutine */ int calpar_();
    extern /* Character */ VOID getnam_();
    static integer iparam;
    extern /* Subroutine */ int moldat_(), update_();
