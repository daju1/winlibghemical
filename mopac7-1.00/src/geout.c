/* geout.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int geout_(mode1)
integer *mode1;
{
    /* Format strings */
    static char fmt_40[] = "(/4x,\002ATOM\002,3x,\002CHEMICAL\002,a,\002BOND\
 LENGTH\002,4x,\002BOND ANGLE\002,4x,\002 TWIST ANGLE\002,/3x,\002NUMBER\002\
,2x,\002SYMBOL\002,a,\002(ANGSTROMS)\002,5x,\002(DEGREES)\002,5x,\002 (DEGRE\
ES)\002,/4x,\002(I)\002,a,\002NA:I\002,10x,\002NB:NA:I\002,5x,\002 NC:NB:NA:I\
\002,5x,\002NA\002,3x,\002NB\002,3x,\002NC\002,/)";
    ...
    static logical cart;
    static integer iprt;
    static char flag0[2], flag1[2];
    static integer i__, j, k, l, n;
    static char q[2*3], flagn[2], blank[80];
    extern /* Subroutine */ int chrge_();
    static doublereal w, x, coord[360]	/* was [3][120] */, q2[120];
    static integer ia, ii;
    static doublereal degree;
    static integer loctmp[720]	/* was [2][360] */, nvartm, maxtxt;
    extern /* Subroutine */ int xyzint_(), wrttxt_();
