/* brlzon.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int brlzon_(fmatrx, fmat2d, n3, sec, vec, b, mono3, step, 
	mode)
doublereal *fmatrx, *fmat2d;
integer *n3;
complex *sec, *vec;
doublereal *b;
integer *mono3;
...
integer *mode;
{
    ...
    extern /* Subroutine */ int dofs_();
    static integer loop;
    static doublereal c__;
    extern /* Subroutine */ int cdiag_();
...
/* L20: */
		i__4 = i__ + j * sec_dim1;
		sec[i__4].r = (float)0., sec[i__4].i = (float)0.;
	    }
	}
	cay = (loop - 1) * *step;
	i__4 = *n3;
