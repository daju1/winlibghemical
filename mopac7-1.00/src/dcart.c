/* dcart.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int dcart_(coord, dxyz)
...
/* Subroutine */ int dhc_(p, pa, pb, xi, nat, if__, im, il, jf, jm, jl, dener,
	 mode)
doublereal *p, *pa, *pb, *xi;
integer *nat, *if__, *im, *il, *jf, *jm, *jl;
doublereal *dener;
integer *mode;
{
    /* Initialized data */
    ...
    /* Local variables */
    static doublereal wlim;
    extern /* Subroutine */ int fock2_();
    ...
    static integer ia, ja, jb, jc, ib, ic, nj, ni, jj, kr, ii;
    ...
    static logical uhf;
    static doublereal wjs[100], wks[100];
