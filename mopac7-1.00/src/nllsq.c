/* nllsq.f -- translated by f2c (version 19991025).
...
UCCESSFUL AFTER\002,i5,5x,\002ORTHOGONAL SEARCHES\002)";
    ...
    /* Builtin functions */
    integer i_indx(), s_wsfe(), do_fio(), e_wsfe(), f_clos();
    double sqrt(), d_sign();
...
MIZABLE.',/     ,' THIS CAN HAPPEN IF (A) IT WAS OPTIMIZED TO BEGIN WITH',/ \
    ,' OR                 (B) IT IS NEITHER A GROUND NOR A',        ' TRANSI\
TION STATE')", 0 };
