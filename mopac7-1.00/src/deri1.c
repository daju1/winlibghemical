/* deri1.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int deri1_(c__, norbs, coord, number, work, grad, f, minear, 
	fd, wmat, hmat, fmat)
doublereal *c__;
integer *norbs;
doublereal *coord;
integer *number;
doublereal *work, *grad, *f;
integer *minear;
doublereal *fd, *wmat, *hmat, *fmat;
{
    /* Initialized data */
    ...
    /* Builtin functions */
    integer i_indx(), s_wsle(), do_lio(), e_wsle(), s_wsfe(), do_fio(), 
	    e_wsfe();
    ...
    static integer iprt;
    extern /* Subroutine */ int mtxm_();
    static integer i__, j, k, l;
    extern /* Subroutine */ int mecid_(), mecih_();
    static logical debug;
    extern /* Subroutine */ int timer_();
    static integer ninit;
    extern /* Subroutine */ int scopy_();
    static integer n1, n2;
    extern /* Subroutine */ int dfock2_(), dijkl1_();
    static doublereal enucl2;
    static integer ll;
    extern /* Subroutine */ int dhcore_();
    extern doublereal helect_();
...
ES (E.V.)'/  '    I    J    K    L       d<I(1)J(1)|K(2)L(2)>')", 0 };
...
/* Subroutine */ int dhcore_(coord, h__, w, enuclr, nati, natx, step)
doublereal *coord, *h__, *w, *enuclr;
integer *nati, *natx;
doublereal *step;
{
    /* Initialized data */
    ...
    /* Local variables */
    static doublereal dwjd[101], enuc;
    static integer nrow, i__, j, k;
    static doublereal denuc, csave;
    static logical mindo;
    static integer i1, i2, j2, j1;
    extern /* Subroutine */ int h1elec_();
    static integer j7, nband2, ia, ib, ic;
    static doublereal di[81]	/* was [9][9] */;
    static integer ja, jb, jc, ii, ij, ni, nj, kr;
    static doublereal cutoff, e1b[10], e2a[10];
    extern /* Subroutine */ int rotate_();
    static doublereal ddi[81]	/* was [9][9] */, wjd[101];
    static integer kro;
    static doublereal de1b[10], de2a[10];
