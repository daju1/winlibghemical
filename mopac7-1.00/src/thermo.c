/* thermo.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int thermo_(a, b, c__, linear, sym, wt, vibs, nvibs, escf)
doublereal *a, *b, *c__;
logical *linear;
doublereal *sym, *wt, *vibs;
integer *nvibs;
doublereal *escf;
{
    /* Initialized data */
...
TED TO\002,/10x,\002MOLECULES WHICH HAVE NO INTERNAL ROTATIONS\002//)";
    ...
    static doublereal t, cpint;
    static integer itemp, istep;
    static doublereal c1, e0, cptot, hr;
    static integer ir;
    static doublereal hv, wi, qr, sr, qv, sv, trange[300];
    static char tmpkey[241];
    static doublereal h298;
...
E RELATIVE TO THE',/12X,' ELEMENTS IN THEIR STANDARD STATE AT 298K')", 0 };
