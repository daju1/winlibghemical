/* repp.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int repp_(ni, nj, rij, ri, core)
integer *ni, *nj;
doublereal *rij, *ri, *core;
{
    /* Initialized data */
    ...
    /* Local variables */
    static doublereal dxdx, dzdz, qxxe, eqxx, qzze, eqzz;
    static integer i__;
    static doublereal r__, dzqxx, qxxdz, dxqxz, qxzdx, dzqzz, qzzdz, da, db, 
	    ee, qa, qb;
    static logical si, sj;
    static doublereal ade, aee, aed, qxxqxx, qxxqyy, qxxqzz, adq, aqe, aeq, 
	    aqd, arg[72], qzzqxx, qzzqzz, qxzqxz, aqq, dze, edz, axx, sqr[72],
	     rsq, www, xxx, yyy, zzz;
