/* powsq.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int powsq_(xparam, nvar, funct)
doublereal *xparam;
integer *nvar;
doublereal *funct;
{
...
/* ***************************** at 1994-05-25 ***** */
	...
	if (i_indx(keywrd_1.keywrd, "GNORM", (ftnlen)241, (ftnlen)5) != 0) {
	    ...
	    if (tol2 < (float).01 && i_indx(keywrd_1.keywrd, " LET", (ftnlen)
		    241, (ftnlen)4) == 0) {
		s_wsfe(&io___15);
