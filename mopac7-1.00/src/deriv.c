/* deriv.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int deriv_(geo, grad)
doublereal *geo, *grad;
{
    /* Initialized data */
    ...
    /* Builtin functions */
    integer i_indx(), f_open(), f_rew(), s_rsfe(), do_fio(), e_rsfe(), s_wsfe(
	    ), e_wsfe();
    ...
    static logical slow;
    static integer i__, j, icapa;
    static logical halfe, debug;
    extern /* Subroutine */ int dcart_();
    ...
    static integer il, jl, kl;
    static doublereal aidref[360];
    static integer ll, kk, idelta;
    extern /* Character */ VOID getnam_();
    static logical precis, noanci, aifrst;
    extern /* Subroutine */ int dernvo_(), jcarin_(), gmetry_(), deritr_(), 
	    symtry_();
    static logical aic;
