/* fock2.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int fock2_(f, ptot, p, w, wj, wk, numat, nat, nfirst, nmidle,
	 nlast)
doublereal *f, *ptot, *p, *w, *wj, *wk;
integer *numat, *nat, *nfirst, *nmidle, *nlast;
{
    /* Initialized data */
    ...
    static integer ione;
    static doublereal a;
    static integer i__, j, k, l, m, ifact[300];
    static doublereal elexc, elrep;
    static integer i1, j1, i1fact[300];
    static doublereal aa, bb;
    static integer ia, ib, ja, jb, jc, ka, kb, ii, ij, ji, ik, ki, kl, lk;
    static doublereal pk[16];
    static integer jl, lj, kk, jk, kj, jj, ll, kc, il;
    static doublereal aj, ak;
    extern /* Subroutine */ int addfck_();
    static integer kr, jindex[256], kindex[256], jjndex[256];
    static doublereal sumdia;
    static integer ijperm[10], llperm[10], mmperm[10];
    static doublereal sumoff;
    static integer iminus, im1;
    extern /* Subroutine */ int jab_(), kab_();
    static logical lid;
...
/* Subroutine */ int jab_(ia, ja, llperm, jindex, jjndex, pja, pjb, w, f)
integer *ia, *ja, *llperm, *jindex, *jjndex;
doublereal *pja, *pjb, *w, *f;
{
    /* System generated locals */
    integer i__1;

    /* Local variables */
    static integer ioff, joff;
    static doublereal suma[10], sumb[10];
    static integer i__, i5, i6, iia, ija;
...
/* Subroutine */ int kab_(ia, ja, pk, w, kindex, f)
integer *ia, *ja;
doublereal *pk, *w;
integer *kindex;
doublereal *f;
