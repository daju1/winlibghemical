/* getgeg.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int getgeg_(iread, labels, geo, na, nb, nc, ams, natoms, 
	int__)
...
logical *int__;
{
    ...
    static char elemnt[2*107+1] = " HHELIBE B C N O FNENAMGALSI P SCLARK CAS\
CTI VCRMNFECONICUZNGAGEASSEBRKRRBSR YZRNBMOTCRURHPDAGCDINSNSBTE IXECSBALACEP\
RNDPMSMEUGDTBDYHOERTMYBLUHFTA WREOSIRPTAUHGTLPBBIPOATRNFRRAACTHPAU NPPUAMCMB\
KCFXXFMMDCB++ +-- -TV";
    ...
    /* Builtin functions */
    integer s_rsfe(), do_fio(), e_rsfe(), s_cmp(), i_indx();
    ...
    static integer ivar, kerr, merr, nerr, lerr, i__, j, k;
    extern doublereal reada_();
    static integer l, n, iline, numat;
...
/* Subroutine */ int getval_(line, x, t, line_len, t_len)
char *line;
doublereal *x;
char *t;
ftnlen line_len;
