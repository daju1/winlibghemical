/* dfock2.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int dfock2_(f, ptot, p, w, numat, nfirst, nmidle, nlast, 
	nati)
doublereal *f, *ptot, *p, *w;
integer *numat, *nfirst, *nmidle, *nlast, *nati;
{
    /* Initialized data */
    ...
    static integer i1, j1, i1fact[300], ia, ib, ja, jb, ka, ii, ij, ji, ik, 
	    ki, kl, lk;
    static doublereal pk[16];
    static integer jl, lj, kk, jk, kj, jj, ll, kr, jindex[256], kindex[256], 
	    jjndex[256];
