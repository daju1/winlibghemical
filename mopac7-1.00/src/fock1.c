/* fock1.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int fock1_(f, ptot, pa, pb)
doublereal *f, *ptot, *pa, *pb;
{
    ...
    static integer ia, ib, ic, ka;
    static doublereal qa[120];
    static integer ii, ni, iminus, im1, icc;
