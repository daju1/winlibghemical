/* enpart.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int enpart_(uhf, h__, alpha, beta, p, q, coord)
logical *uhf;
doublereal *h__, *alpha, *beta, *p, *q, *coord;
{
    /* Format strings */
...
EV\002//)";
    ...
    /* Local variables */
    static doublereal eabr, eabx;
    static integer kinc;
    static doublereal tone, ttwo, eabee, g;
    static integer i__, j, k, l;
    static doublereal eaben;
    static integer n;
    static doublereal r__, eabnn, t, scale;
    static integer nbond;
    static doublereal eabrx, oneii, onejj;
    static logical mindo3;
    static doublereal aa, bb;
    static integer numat1, ia, ib, ja, jb, ka, kc, ig, kb, ii, ij, jj, ik, ni,
	     kl, kk, nj, jk, il;
    static doublereal ex[21780]	/* was [7260][3] */;
    static integer jl, lk;
    static doublereal et;
    static integer nt, linear, ia1, ia2;
    static logical am1;
