/* dtrti2.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int dtrti2_(uplo, diag, n, a, lda, info, uplo_len, diag_len)
char *uplo, *diag;
integer *n;
doublereal *a;
integer *lda, *info;
...
ftnlen diag_len;
{
    ...
    /* Local variables */
    static integer j;
    extern /* Subroutine */ int mMdscal_();
    extern logical lsame_();
    static logical upper;
    extern /* Subroutine */ int dtrmv_(), xerbla_();
...
/*           COMPUTE ELEMENTS 1:J-1 OF J-TH COLUMN. */
	    ...
	    dtrmv_("UPPER", "NO TRANSPOSE", diag, &i__2, &a[a_offset], lda, &
		    ...
		    1);
	    i__2 = j - 1;
	    mMdscal_(&i__2, &ajj, &a[j * a_dim1 + 1], &c__1);
/* L10: */
	}
    } else {
...
/*              COMPUTE ELEMENTS J+1:N OF J-TH COLUMN. */
		...
		i__1 = *n - j;
		mMdscal_(&i__1, &ajj, &a[j + 1 + j * a_dim1], &c__1);
	    }
/* L20: */
	}
    }
