/* diis.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int diis_(xp, xparam, gp, grad, hp, heat, hs, nvar, frst)
doublereal *xp, *xparam, *gp, *grad, *hp, *heat, *hs;
integer *nvar;
logical *frst;
{
    ...
    static integer mset;
    extern /* Subroutine */ int minv_();
    static doublereal xmax, xset[5400], b[256];
...
ONED', /10X,' - PROBABLY, VECTORS ARE LINEARLY DEPENDENT - ',         /10X,'\
THE DIIS STEP WILL BE REPEATED WITH A SMALLER SPACE')", 0 };
...
/* Subroutine */ int space_(mreset, mset, xparam, grad, heat, nvar, xset, 
	gset, eset, frst)
integer *mreset, *mset;
doublereal *xparam, *grad, *heat;
integer *nvar;
doublereal *xset, *gset, *eset;
logical *frst;
{
    /* System generated locals */
    integer i__1, i__2;
    ...
    /* Local variables */
    static integer i__, k, mi, ni, nreset, nmk;
...
doublereal *d__;
{
    ...
    static integer i__, j, k, l[360], m[360], ij, ki, kk, ji, jk, nk, jp, ik, 
	    kj, jq, jr, iz;
