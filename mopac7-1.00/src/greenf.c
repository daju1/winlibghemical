/* greenf.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int greenf_()
{
    /* Format strings */
    static char fmt_10[] = "(///)";
    static char fmt_20[] = "(10x,\002***************************************\
*********\002/10x,\002*                                              *\002/1\
0x,\002*   SEMIEMPIRICAL GREEN FUNCTION CALCULATION   *\002/10x,\002*       \
                                       *\002/10x,\002*  This package was wri\
tten by Dr. D.Danovich  *\002/10x,\002*            Chemistry Department     \
         *\002/10x,\002*    TECHNION-Israel Institute of Technology   *\002/\
10x,\002*      Technion City, Haifa  32000, ISRAEL     *\002/10x,\002*      \
                                        *\002/10x,\002**********************\
**************************\002)";
    ...
    extern /* Subroutine */ int mo_();
#define iw ((integer *)&chanel_1 + 5)
    extern /* Subroutine */ int insymc_();
    static integer memory, iao, mmm;
...
/* Subroutine */ int gstore_(ii, jj, kk, ll, wert, pgr, nmux)
integer *ii, *jj, *kk, *ll;
doublereal *wert, *pgr;
integer *nmux;
{
    static integer nnnn, lt, iii, jjj, kkk, lll;
...
/* Subroutine */ int insymc_()
{
    /* Format strings */
    static char fmt_3185[] = "(///1x,\002NUMBER OF OCCUPIED MOS\002,4x,i4,/1\
x,\002NUMBER OF UNOCCUPIED MOS\002,2x,i4,/1x,\002PRINTING FLAG\002,13x,i4)";
    ...
    extern /* Subroutine */ int nuchar_();
    static integer nvalue, ioutci, nra;
...
integer *memory;
{
    ...
    extern /* Subroutine */ int fcnpp_(), moint_();
    static integer i10;
#define iw ((integer *)&chanel_1 + 5)
    static integer loadfm;
    extern /* Subroutine */ int worder_();
...
/* Subroutine */ int moint_(c__, pgr, cc, w, c12, norbs, lm2, lm8, kmax, nmux)
doublereal *c__, *pgr, *cc, *w, *c12;
integer *norbs, *lm2, *lm8, *kmax, *nmux;
{
    /* Initialized data */
...
ALS.\002/)";
    ...
    /* Local variables */
    static integer iend, lmax, i__, j, k, l;
    extern doublereal sisms_();
    static integer ii, ij, ik, il;
#define iw ((integer *)&chanel_1 + 5)
    extern /* Subroutine */ int ccprod_(), gstore_(), wwstep_();
...
/* Subroutine */ int suma2_(p, ndis, ep)
doublereal *p;
integer *ndis;
doublereal *ep;
{
    ...
    /* Local variables */
    static integer numb, numb1, i__, j, m, n, ii, jj, mm, nn, lt, iyr, myr, 
	    kyr2, kyr1;
...
/* Subroutine */ int worder_(cc, lm7, iout2)
doublereal *cc;
integer *lm7, *iout2;
{
    /* Initialized data */
...
HICH CONTAINS\002,i4/2x\002 COLUMNS AND\002,i6,\002 INTEGRALS.\002)";
    ...
    /* Local variables */
    static integer lrec, imax, kmax, lmax, indx[120], indy[120], ktot, i__, j,
	     k, l, ia, ib, ja, la, lb, na, jb, ka, ii, kb, jj, kk, ni, kp, nn,
	     no, ks;
#define iw ((integer *)&chanel_1 + 5)
    static integer jw, ns, iminus, iw1, kgo;
...
/* Subroutine */ int wwstep_(c12, cc, ww, lm7, kmax, lmax)
doublereal *c12, *cc, *ww;
integer *lm7, *kmax, *lmax;
{
    /* System generated locals */
    integer i__1;
...
integer *ndis;
{
    ...
    /* Local variables */
    static integer numb, numb1, numb2, numb3, numb4, i__, j, k, l, m, n, ii, 
	    jj, kk, ll, mm, nn, lt, iyr, kyr1, kyr2, myr1;
...
/* Subroutine */ int ccprod_(c1, c2, c12, lm2, lm6)
doublereal *c1, *c2, *c12;
integer *lm2, *lm6;
{
    /* System generated locals */
    integer i__1;
...
/* Subroutine */ int csum_(p, ndis, ep)
doublereal *p;
integer *ndis;
doublereal *ep;
{
    ...
    /* Local variables */
    static integer numb, numb1, numb2, numb3, i__, j, k, l, m, n, ii, kk, jj, 
	    ll, mm, nn, lt, iyr, kyr1, kyr2, myr1;
...
/* Subroutine */ int dsum_(p, ndis, ep)
doublereal *p;
integer *ndis;
doublereal *ep;
{
    ...
    /* Local variables */
    static integer numb, numb1, numb2, numb3, numb4, numb5, numb6, i__, j, k, 
	    l, m, n, ii, jj, kk, ll, mm, nn, lt, iyr, kyr1, kyr2, myr1;
...
VOLVED IN THE\002/5x,\002 OVGF CALCULATION =\002,i3/5x,\002TOTAL NUMBER OF U\
NOCCUPIED \002,\002ORBITALS INVOLVED IN THE\002/5x,\002 OVGF CALCULATION \
=\002,i3/5x,\002THE NUMBER OF FIRST OCCUPIED MO FOR WHICH OVGF CORRECTION\
 \002/5x,\002MUST BE STARTED =\002,i3/5x,\002THE NUMBER OF LAST OCCUPIED MO \
FOR WHICH OVGF CORRECTION \002/5x,\002MUST BE  FINISHED =\002,i3/5x,\002TOLE\
RANCE FACTOR = \002,f12.8/5x,\002SECOND-ORDER CONTRIBUTION = \002,i3/5x,\002\
THIRD-ORDER CONTRIBUTION = \002,i3/5x,\002FULL EXPRESSION = \002,i3/5x,\002P\
RINT FACTOR = \002,i3/5x,\002ONLY SECOND-ORDER CONTRIBUTION = \002,i3)";
 ...
 \002,3x,\002 3   \002,2x,\002 IR \002,3x,\002 FINAL \002,2x,\002 IR \002,3x,\
\002 SCF\002)";
...
x,f7.3)";
 ...
 and \002,i5,\002 LUMO \002/5x,\002 ACCURACY SELFCONSISTENT  = \002,f12.8/5x,\
\002 FINAL RESULT CALCULATED BY \002,i3,\002  METHOD \002)";
    static char fmt_84[] = "(//6x,\002FINAL=0, CALCULATED BY  FORMULA W=EP+S\
UM2+(1+A)\002,\002**(-1)*SU3R\002/6x,\002FINAL=1, CALCULATED BY FORMULA W=EP\
+SUM2+(1+G1)**-1)\002/3x,\002*(CS4+CS5+CS6+DS4+DS5+DS6)+(1+G2)**(-1)*(CS1+CS\
2+CS3+DS1\002/3x,\002+DS2+DS3)+AA\002/6x,\002FINAL= -1, CALCULATED BY FORMUL\
A W=EP+SUM2+(1+A)**(-1)*SUM3\002)";
...
NERGY SCF\002,5x,\002ENERGY\002)";
    ...
    extern /* Subroutine */ int asum_();
    static integer numh;
    extern /* Subroutine */ int csum_(), dsum_();
    ...
    extern /* Subroutine */ int suma2_();
    static integer nymb1;
    static doublereal a;
    static integer i__, j, l;
    static doublereal w, value[40];
    static integer iggww;
    static doublereal g1, g2, zsuma, w1, zverx;
    static integer ii;
    static doublereal ep;
    static integer jj, ll, ir, lt;
    static doublereal ps;
    extern /* Subroutine */ int nuchar_();
    static integer nvalue, ifulit;
    static doublereal eg2[20];
    static integer ig2[20], iprint;
