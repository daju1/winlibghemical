...
file_export_dialog::file_export_dialog(gtk_project * p1) : glade_dialog("glade/file_export_dialog.glade")
{
	prj = p1;
...
void file_export_dialog::handler_Destroy(GtkWidget *, gpointer data)		// not really needed...
{
...
void file_export_dialog::handler_ButtonOK(GtkWidget *, gpointer data)
{
	...
	ref->prj->ExportFile(filename, index);
...
void file_export_dialog::handler_ButtonCancel(GtkWidget *, gpointer data)	// not really needed...
{
	file_export_dialog * ref = (file_export_dialog *) data;
	//cout << "handler_ButtonCancel() : ref = " << ref << endl;
}

void file_export_dialog::handler_ButtonBrowse(GtkWidget *, gpointer data)
{
	file_export_dialog * ref = (file_export_dialog *) data;
...
void file_export_dialog::handler_FileChooser(GtkWidget *, gpointer data)
{
	file_export_dialog * ref = (file_export_dialog *) data;
