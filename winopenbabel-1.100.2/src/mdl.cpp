...
bool ReadSDFile(istream &ifs,OBMol &mol,const char *title) {
  ...
  //nbonds = atoi((r1.substr(3,3)).c_str());// original string
  nbonds = atoi((r1.substr(3,4)).c_str());// my correction for reading molecules with large number of bonds
