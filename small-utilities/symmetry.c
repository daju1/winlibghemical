 ...
 *
 * $Log: symmetry.c,v $
 * Revision 1.1  2002/01/25 16:09:30  hutchisn
 * Add Symmetry program (from Sergei Pachkovsky, who gave OK to use in Ghemical)
 *
...
for( argc--, argv++ ; argc > 0 ; argc -= 2, argv += 2 ){
    ...
    if( strcmp( *argv, "-help"         ) == 0 ||
        ...
        printf( "This is version $Revision: 1.1 $ ($Date: 2002/01/25 16:09:30 $)\n" ) ;
        exit( EXIT_SUCCESS ) ;
        }
    else
    if( strcmp( *argv, "--"            ) == 0 ){
